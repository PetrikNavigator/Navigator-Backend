...
export function SeedCorridors(count: number): Prisma.corridorsCreateManyInput[] {
    ...
    const corridors: Prisma.corridorsCreateManyInput[] = [
        ...
        { name: "Udvar B fele", storey: 0, x1: 33, y1: 15, x2: 137, y2: 15, width: 16, barrier_free: true, is_outdoor: true, building_id: 1 },
        ...
        // B epulet
        // foldszint
        { name: "Lépcső a B épületbe", storey: 0, x1: -55, y1: 14, x2: 9, y2: 14, width: 8, barrier_free: false, is_outdoor: true, building_id: 2 },
        { name: "Adadálymentes út a B épületbe", storey: 0, x1: -55, y1: 22, x2: 54, y2: 22, width: 8, barrier_free: true, is_outdoor: true, building_id: 2 },
        { name: "Akadálymentes a B-be", storey: 0, x1: 9, y1: 14, x2: 54, y2: 14, width: 8, barrier_free: true, is_outdoor: true, building_id: 2 },
        ...
        { name: "Belső folyosó", storey: 1, x1: -34, y1: -43, x2: 11, y2: -43, width: 5, barrier_free: true, is_outdoor: false, building_id: 2 },
    ]
