...
--
-- Gép: localhost:3305
-- Létrehozás ideje: 2026. Jún 05. 13:27
...
(2, 'B épület', 'Vegyészek és környezetvédők épülete', 12, -4);
...
(56, 'B003', 1, 0, 0, 0, 180, 10, 15, 6, 'az kapu zarva van', 2, 30),
(57, 'B005', 1, 0, -12, 0, 180, 11, 15, 6, 'vegyel itt valamit', 2, 35),
(58, 'B006', 1, 0, -26, 0, 180, 14, 15, 6, 'dok centrum, kedvesek', 2, 36),
(59, 'B007', 1, 0, -37, 0, 180, 5, 15, 6, 'Penksza', 2, 27),
(60, 'B008', 1, 0, -44, 0, 180, 6, 15, 6, 'neha ide is jonni kell', 2, 37),
...
(64, 'B029', 1, 0, -9, -37, 0, 7, 8, 6, 'jobb mint az A epuletben', 2, 26),
(65, 'B032', 1, 0, -9, -29, 0, 7, 6, 6, 'vece', 2, 28),
(66, 'B033', 1, 0, -1, -33, 0, 7, 14, 6, 'event', 2, 29),
(67, 'B035', 1, 0, 7, -33, 0, 7, 14, 6, 'sose lattam', 2, 38),
(68, 'B041', 1, 0, 22, 0, 180, 17, 15, 6, 'terem', 2, 5),
(69, 'B043', 1, 0, 28, -58, 0, 7, 14, 6, 'ilyen is van ezek szerint', 2, 8),
(70, 'B044/A', 1, 0, 37, -54, 0, 9, 6, 6, 'konyvtaros terem', 2, 39),
(71, 'B044/B', 1, 0, 20, -58, 0, 7, 14, 6, 'dok', 2, 40),
(72, 'B045', 1, 0, 29, -33, 0, 25, 12, 6, 'lehet kolcsonozni', 2, 25),
(73, 'B048', 1, 0, 29, -43, 180, 5, 7, 6, 'valahol oltozni is kell', 2, 10),
(74, 'B051', 1, 0, 37, -61, 0, 9, 7, 6, 'itt talalhato a pszicholohus', 2, 41),
(75, 'B103', 1, 1, -52, 0, 180, 17, 15, 6, 'itt vannak tanarok', 2, 19),
(76, 'B105', 1, 1, -28, 0, 180, 8, 15, 6, 'itt titkarok vannak', 2, 43),
(77, 'B106', 1, 1, -15, 0, 180, 16, 15, 6, 'innen igazgatjak az iskolat', 2, 44),
(78, 'B107', 1, 1, -1, 0, 180, 10, 15, 6, 'gazdalkodj okosan', 2, 45),
(79, 'B110', 1, 1, 9, 0, 180, 8, 15, 6, 'hat akkor ilyen is van', 2, 46),
(80, 'B111', 1, 1, 18, 0, 180, 8, 15, 6, 'helyettesiti az igazgatot', 2, 27),
(81, 'B112', 1, 1, 32, 0, 180, 18, 15, 6, 'eretsegi terem', 2, 47),
(82, 'B116', 1, 1, 27, -44, 0, 25, 34, 10, 'Petrik Előadó', 2, 42),
...
(87, 'B137', 1, 1, -27, -33, 0, 8, 13, 6, 'itt van egyedul wc papir ', 2, 26),
(88, 'B138', 1, 1, -17, -33, 0, 8, 13, 6, 'ez egy noi wc', 2, 28),
(89, 'B140', 1, 1, -7, -33, 0, 8, 13, 6, 'event', 2, 29),
(90, 'B203', 1, 2, 3, -33, 0, 8, 13, 6, 'wc', 2, 1),
(91, 'B204', 1, 2, -52, 0, 180, 17, 15, 6, 'itt vannak tanarok', 2, 1),
(92, 'B205', 1, 2, -28, 0, 180, 8, 15, 6, 'itt titkarok vannak', 2, 1),
(93, 'B206', 1, 2, -15, 0, 180, 16, 15, 6, 'innen igazgatjak az iskolat', 2, 1),
(94, 'B207', 1, 2, -1, 0, 180, 10, 15, 6, 'gazdalkodj okosan', 2, 1),
(95, 'B208', 1, 2, 9, 0, 180, 8, 15, 6, 'hat akkor ilyen is van', 2, 5),
(96, 'B210', 1, 2, 18, 0, 180, 8, 15, 6, 'masik eloado', 2, 42),
(97, 'B212', 1, 2, 32, 0, 180, 18, 15, 6, 'eretsegi terem', 2, 3),
(98, 'B213', 1, 2, 27, -44, 0, 25, 34, 10, 'Petrik Előadó', 2, 3),
(99, 'B214', 1, 2, 6, -53, 0, 15, 15, 6, 'nem jartam itt soha', 2, 3),
(100, 'B215', 1, 2, -10, -53, 0, 15, 15, 6, 'itt se jartam soha', 2, 3),
(101, 'B216', 1, 2, -26, -53, 0, 15, 15, 6, 'harmadik ugyanolyan terem', 2, 3),
(102, 'B223', 1, 2, -41, -51, 0, 11, 19, 6, 'hu de jo keszuljetek ezaz', 2, 3),
(103, 'B230', 1, 2, -27, -33, 0, 8, 13, 6, 'itt van egyedul wc papir ', 2, 3),
(104, 'B231', 1, 2, -17, -33, 0, 8, 13, 6, 'ez egy noi wc', 2, 26),
(105, 'B234', 1, 2, -7, -33, 0, 8, 13, 6, 'event', 2, 28),
(106, 'B235', 1, 2, 3, -33, 0, 8, 13, 6, 'wc', 2, 29),
(106, 'B238', 1, 2, 3, -33, 0, 8, 13, 6, 'wc', 2, 33);
...
(35, 'büfé', '#ff932eff'),
(36, 'diákközpont', '#00ff4cff'),
(37, 'orvosi szoba', '#ea8b8bff'),
(38, 'személyzeti wc', '#ffffffff'),
(39, 'könyvtáros', '#b68949ff'),
(40, 'diákönkormányzat', '#f99effff'),
(41, 'pszichológus', '#39f3deff'),
(42, 'előadó terem', '#792f83ff'),
(43, 'titkárság', '#327167ff'),
(44, 'igazgató', '#fa0000ff'),
(45, 'gazdasági vezető', '#49ab55ff'),
(46, 'gazdasági iroda', '#a9b234ff'),
(47, 'tárgyaló', '#6c007aff');
...
(34, 'Belső folyosó2', 2, -34, -43, 11, -43, 5, 1, 0, 2);
